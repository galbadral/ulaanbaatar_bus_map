...
with row1_2:
    st.write(
        """
    ##
    Улаанбаатарын 3 сарын 6-ны өдрийн нийт автубасаар үйлчлүүлэгчдын картаа даран зорчисон өгөгдлийг ашиглан энэхүү 3D heatmap-ийг боловсруулав.
    """
    )
    st.write(
             """
...
with tab1:
    ...
    with row2_1:
        st.write(
            f"""**Улаанбаатарт автобусанд суусан хүмүүс, {hour_selected}:00 болон {(hour_selected + 1) % 24}:00 цагийн хооронд**"""
        )
        map(filterdata(data, hour_selected), midpoint[0], midpoint[1], 11)

    with row2_2:
        st.write(
            f"""**Тус цагт автобуснаас картаа дарж буусан хүмүүс**"""
        )
